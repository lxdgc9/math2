    ...
    <>
      ...
      <Container maxWidth={false}>
        <Grid container spacing={1}>
          ...
          <Grid item xs={12} md={6}>
            <Card sx={{ height: '100%', maxHeight: '600px' }}>
              <CardHeader title="Biểu đồ dữ liệu dạng diện tích" />

              <CardContent>
                <StyledChart dir="ltr" type="radar" series={chartValue} options={chartOptions} />
              </CardContent>
            </Card>
          </Grid>
        </Grid>
